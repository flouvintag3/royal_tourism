        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="messages.php"><i class="fa fa-desktop"></i> News Letters / Feedback</a>
                    </li>
					<li>
										...
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==1 )
											{
												echo"<tr class='gradeC'>
                                                    ...
                                                    <td><a href=pay.php?amt=".$row['ttot'] ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Pay</button></td>
													</tr>";
											}
											else
											{
